...
const Points = () => {
    ...
    useEffect(()=>{
        async function loadPosition(){
            ...
            if(status !== 'granted'){
                Alert.alert('Oopes...', 'Precisamos da sua permissão para obter a localização')
                return;
            }
        ...
        <>
            <View style={styles.container}>
                ...
                <View style={styles.mapContainer}>
                    {/* condição ternária para renderizar elementos. 
                    precisamos esperar o app pegar a localização para então
                    renderizar o mapa */}
                    { initialPosition[0] !== 0 && (
                        <MapView 
                        style={styles.map} 
